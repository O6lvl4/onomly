...
| # | 観点 | 中身 |
|---|------|------|
| 1 | **機械チェック** (`onomly.almd`) | npm / crates.io / PyPI / RubyGems / Homebrew / GitHub / ドメイン(`.com .ai .io .dev .org`、権威 RDAP→whois)+ TMview 商標スクリーン(日米欧 1 クエリ) |
...
- 商標は TMview(JPO / USPTO / EUIPO 含む約 75 庁横断)で同名ワードマークをスクリーニング。スクリーンでありクリアランスではない(称呼類似・区分判断はしない)ので、リスクが見えた候補は正式な商標調査(弁理士)を推奨
